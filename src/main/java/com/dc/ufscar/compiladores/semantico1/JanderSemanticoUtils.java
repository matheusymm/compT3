...
public class JanderSemanticoUtils {
    ...
    public static boolean verificarTipoCompativeL(TabelaDeSimbolos tabela, TabelaDeSimbolos.TipoJander tipo1, TabelaDeSimbolos.TipoJander tipo2) {
        TabelaDeSimbolos.TipoJander aux1 = tabela.verificar(tipo1.toString()), aux2 = tabela.verificar(tipo2.toString());
        if(aux1 == aux2 || aux1 == TabelaDeSimbolos.TipoJander.REAL && aux2 == TabelaDeSimbolos.TipoJander.INTEIRO || aux1 == TabelaDeSimbolos.TipoJander.INTEIRO && aux2 == TabelaDeSimbolos.TipoJander.REAL) {
            return true;
        } else {
            return false;
        }
    ...
    public static TabelaDeSimbolos.TipoJander verificarTipo(TabelaDeSimbolos tabela, JanderParser.Exp_aritmeticaContext ctx) {
